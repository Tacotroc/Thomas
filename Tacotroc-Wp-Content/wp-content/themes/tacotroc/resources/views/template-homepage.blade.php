        ...
        <div id="logo_container">
          ...
          <div class="ffve_logo">
            <a href="https://www.ffve.org/" target="blank">
              <img src="@asset('images/Logo-FFVE.png')" alt="logo ffve" title="Fédération Française des Véhicules d'époque" />
            </a>
          </div>

            <div class="euratech_logo">
              <img src="@asset('images/logos-partenaires-EURATECH.png')" alt="euratech logo" title="EuraTechnologie" />
              </a>
            </div>

            <div class="INITIATIVE_logo">
              <img src="@asset('images/logos-partenaires-INITIATIVE.png')" alt="logo INITIATIVE" title="Initiative Lille Métropole Nord" />
              </a>
            </div>

          <div class="MEL_logo">
            <img src="@asset('images/logos-partenaires-MEL.png')" alt="logo Metropole Européenne de Lille" title="Métropole Européenne de Lille" />
            </a>
          </div>
    ...
    <?php if (count($events) > 0) : ?>
      <div id="events">
        <div class="slideshow">
          <h2>Évènements</h2>
          <div class="btn-bar">
            <p id="prev" onclick="plusSlides(-1)"><img src="@asset('images/img_index/arrowRight.png')" alt="flèche" id="arrow" style="transform:rotate(180deg)" /></p>
            <p id="next" onclick="plusSlides(+1)"><img src="@asset('images/img_index/arrowRight.png')" alt="flèche" id="arrow" /></p>
          </div>
          <div class="slideshow-container" id="slide">
            <?php foreach ($events as $key => $event) : ?>
              <p class="mySlides<?php if ($key === 0) : echo " active";
                                endif; ?>" id="indice-<?= $key + 1 ?>">
