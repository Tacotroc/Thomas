        ...
        <div id="logo_container">
          ...
          <div class="ffve_logo">
            <a href="https://www.ffve.org/" target="blank">
              <img src="<?= App\asset_path('images/Logo-FFVE.png'); ?>" alt="logo ffve" title="Fédération Française des Véhicules d'époque" />
            </a>
          </div>

            <div class="euratech_logo">
              <img src="<?= App\asset_path('images/logos-partenaires-EURATECH.png'); ?>" alt="euratech logo" title="EuraTechnologie" />
              </a>
            </div>

            <div class="INITIATIVE_logo">
              <img src="<?= App\asset_path('images/logos-partenaires-INITIATIVE.png'); ?>" alt="logo INITIATIVE" title="Initiative Lille Métropole Nord" />
              </a>
            </div>

          <div class="MEL_logo">
            <img src="<?= App\asset_path('images/logos-partenaires-MEL.png'); ?>" alt="logo Metropole Européenne de Lille" title="Métropole Européenne de Lille" />
            </a>
          </div>
