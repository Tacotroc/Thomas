...
<?php
  ...
  <?php else : ?>
    <?php
      ...
      $subtotal = number_format($price * 0.15, 2, '.', '');
      $total = number_format($price + $subtotal, 2, '.', '');
    ?>
    ...
    <aside class="pay-right">
      ...
      <?php if($step === "paiement"): ?>
        <div class="sub-total">
            <p><span>Frais de traitement de transaction</span><span><?= $order["feet_order"] ?>€ HT</span></p>
      ...
      <?php else: ?>
        <div class="sub-total">
            <p><span>Frais de traitement de transaction</span><span><?= $subtotal ?>€ HT</span></p>
