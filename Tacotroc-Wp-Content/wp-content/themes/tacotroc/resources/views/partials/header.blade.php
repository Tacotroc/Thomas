<?php 
header('Access-Control-Allow-Origin: http://tacotroc.lul/')
?>
...
<header>
    ...
    <div class="headerContainer searching">
      ...
      <form>
        <p id="searchInput">
          <input id="query" type="search" placeholder="Marque, modèle" value="<?= isset($_GET["q"]) && !empty($_GET["q"]) ? $_GET["q"] : "" ?>"><img src="@asset('images/loupe.png')" alt="loupe" id="loupe" /><br />
        ...
        <p id="selectInput" onclick="showBigMenu()"><span id="changing">Toutes pièces</span><span id="searchImg"><img src="@asset('images/arrowDown.png')" alt="flèche vers le bas" id="bottomArrow" /></span></p>
    ...
    <a href="<?= get_permalink(83) ?>">
      <div id="new">
        <img src="@asset('images/Button_annonce.png')" alt="bouton" id="buttonAnnonce" style="display:none" />
        <p><span id="plusNew"><img src="@asset('images/plus.png')" alt="plus" id="plus" /></span><span id="textNew">Déposer une annonce</span></p>
      </div>
    </a>
  </header>
