<header>
    <div id="headerContainer">
      ...
      <form>
        <p id="searchInput">
          <input id="query" type="search" placeholder="Marque, modèle"><img src="<?= App\asset_path('images/loupe.png'); ?>" alt="loupe" id="loupe" /><br />
          <span><input type="radio" name="search_type" id="radio1" value="offre" checked="checked" /><label for="radio1">offres</label></span>
          <span><input type="radio" name="search_type" id="radio2" value="demande"  /><label for="radio2">Demandes</label></span>
          <span><input type="radio" name="search_type" id="radio3" value="echange"  /><label for="radio3">Echanges</label></span>
        </p>
