...
<div id="flex_position">
  ...
  <section id="imageAjoutee">
    <div id="doubleImages">
      <div>
        <img id="img1marque" src="<?= App\asset_path('images/SIGLES_Emblemes_Marques_500.png'); ?>" alt="">
      </div>
      <div>
        <img id="img2marque" src="<?= App\asset_path('images/Panneaux_marques_expo_salon_500.png'); ?>" alt="">
      </div>
    </div>
