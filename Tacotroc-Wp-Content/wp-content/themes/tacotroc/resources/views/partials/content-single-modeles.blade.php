...
<div id="carouselPic">
  <img src="@asset('images/img_model/croix.png')" alt="croix" id="croix" />
  <div class="slideshow">
      <div class="btn-bar">
          <p id="prev" onclick="plusSlide(-1)"><img src="@asset('images/img_index/arrowRight.png')" alt="flèche" id="arrow" style="transform:rotate(180deg)" /></p>
          <p id="next" onclick="plusSlide(+1)"><img src="@asset('images/img_index/arrowRight.png')" alt="flèche" id="arrow" /></p>
      </div>
