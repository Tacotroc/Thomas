<header>
    <div class="banner">
      <div class="headerContainer">
        ...
        <div class="social">
          <a href="https://twitter.com/tacotroc">
            <img src="<?= App\asset_path('images/social/twitter.png'); ?>" />
          </a>
          <a href="https://www.facebook.com/tacotroc.fr">
    ...
    <div class="headerContainer searching">
      ...
      <form>
        <p id="searchInput">
          ...
          <span><input type="radio" name="search_type" id="radio2" value="demande"<?= isset($_GET['type']) && $_GET['type'] == "demande" ? ' checked="checked"' : "" ?>/><label for="radio2">Demandes</label></span>
          <span><input type="radio" name="search_type" id="radio3" value="echange"<?= isset($_GET['type']) && $_GET['type'] == "echange" ? ' checked="checked"' : "" ?>/><label for="radio3">Echanges</label></span>
        </p>
